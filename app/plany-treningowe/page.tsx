...
const TrainningPlans = () => {
	return (
		<section className='text-black min-h-[82vh] fle flex-col justify-center items-center text-center mt-10 mb-10 max-w-5xl'>
			<h1 className='text-2xl sm:text-3xl uppercase'>
				Przykładowe plany treningowe
			</h1>
			<p className='mt-[1rem] text-2xl text-start'>
			...
			<div className='flex flex-col gap-y-3 mt-[2rem] text-xl'>
				<Link href='/plany-treningowe/zestaw-1'>
					<Button
						className='flex gap-2 items-center justify-between w-1/2 p-2 px-4'
						variant='white'
                        size='lg'
					>
						<p className='text-lg'>
				...
				<Link href='/plany-treningowe/zestaw-plecy-barki'>
					<Button
                        ...
                        size='lg'
					>
						<p className='text-lg'>Zestaw plecy i barki</p>
						<ArrowBigRight color='black' size='30px' />
					</Button>
				</Link>
				<Link href='/plany-treningowe/zestaw-nogi-biceps'>
					<Button
						...
						size='lg'
					>
						<p className='text-lg'>Zestaw nogi i biceps</p>
						<ArrowBigRight color='black' size='30px' />
					</Button>
				</Link>
			</div>
